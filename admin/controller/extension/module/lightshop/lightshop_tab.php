<?php
class ControllerExtensionModuleLightshopLightshopTab extends Controller {    
	private $error = array();

	public function index() {
		$this->load->language('extension/module/lightshop/lightshop_tab');
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_extension_theme_lightshop->saveLsCustTabs($this->request->post,false);
			...
			$this->response->redirect($this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) { 
			$this->model_extension_theme_lightshop->saveLsCustTabs($this->request->post,$this->request->get['cust_tab_id']);
			$this->session->data['success'] = $this->language->get('text_success');
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $cust_tab_id) {
				$this->model_extension_theme_lightshop->deleteTab($cust_tab_id);
			}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('extension/module/lightshop/lightshop_tab/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('extension/module/lightshop/lightshop_tab/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$results = $this->model_extension_theme_lightshop->getLsTabs($filter_data);


		$tab_total = $this->model_extension_theme_lightshop->getTotalLsTab();
		...
		foreach ($results as $result) {
			$data['tabs'][] = array(
				...
				'edit'           => $this->url->link('extension/module/lightshop/lightshop_tab/edit', 'user_token=' . $this->session->data['user_token'] . '&cust_tab_id=' . $result['cust_tab_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . '&sort=id.title' . $url, true);
		$data['sort_date_added'] = $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . '&sort=i.date_added' . $url, true);
		$data['sort_sort_order'] = $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . '&sort=i.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);

		$data['pagination'] = $pagination->render();
		$data['reset'] = $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] , true);
		...
		$this->response->setOutput($this->load->view('extension/module/lightshopcatalog/lightshop_tab_list', $data));
	}
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (!isset($this->request->get['cust_tab_id'])) {
			$data['action'] = $this->url->link('extension/module/lightshop/lightshop_tab/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('extension/module/lightshop/lightshop_tab/edit', 'user_token=' . $this->session->data['user_token'] . '&cust_tab_id=' . $this->request->get['cust_tab_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('extension/module/lightshop/lightshop_tab', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['cust_tab_id'])) {
			$tab_info = $this->model_extension_theme_lightshop->getLsTab($this->request->get['cust_tab_id']);
		}
		...
		$this->response->setOutput($this->load->view('extension/module/lightshopcatalog/lightshop_tab_form', $data));
	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'extension/module/lightshop/lightshop_tab')) {
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_instanse'])) {
			...
			$results = $this->model_extension_theme_lightshop->getLsTabInstanses($filter_data);
